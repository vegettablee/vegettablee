...
1. _Email Internship Automation Tool_ (Python, SQLite)
   - Multi-agent CLI tool that helps automates internship cold email outreach through dynamic email drafting and resume selection with control over tone, template, and    word count.
